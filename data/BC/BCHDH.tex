...
{\fontsize{19}{20}\fontfamily{phv}\selectfont Hệ Điều Hành}\\[1cm]
{\fontsize{17}{24}\fontfamily{cmr}\selectfont Đề tài:}\\[1cm]
{\fontsize{17}{24}\fontfamily{cmr}\selectfont Thuật toán lập lịch thời cho hệ thống thời gian thực}\\[2cm]
\end{center}
...
\end{longtable}
\hspace{0.3cm}\fontsize{14}{16}\fontfamily{cmr}\selectfont \textbf{Giáo viên hướng dẫn:} \\[1.0cm]
\begin{center}
